...
<p>
To start off this example, I had to first configure the Roles on osTicket. I did that by going to the Admin Panel, clicking on the Agents tab, and then on the Roles tab. Once I was in the Roles section, I clicked the "Add New Role" tab and created the Supreme Admin Role while also assigning it permissions. The permissions I assigned to the new role will allow certain access on to it on osTicket.
</p>
<br />
